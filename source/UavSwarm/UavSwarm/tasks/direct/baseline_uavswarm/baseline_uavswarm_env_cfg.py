...
@configclass
class CurriculumCfg:
    active_stage: int = 5  # Current active stage (1 to 5)
    
# ✅ NEW: Episode durations per stage
    stage1_episode_length_s: float = 60.0   # Hover
    stage2_episode_length_s: float = 90.0   # Point-to-point
    stage3_episode_length_s: float = 240.0   # Obstacles
    stage4_episode_length_s: float = 300.0   # Swarm
    stage5_episode_length_s: float = 300.0  # Swarm + obstacles
    ...
    ##--- Common parameters ---##
    spawn_height_range: tuple = (0.8, 1.2)  # spawn height range for all stages
