...
# ============================================================
### TODO Adjust this env for the avoid collision task
...
from .avoid_collision_env_cfg import AvoidCollisionUAVSwarmEnvCfg
...
class AvoidCollisionUAVSwarmEnv(DirectMARLEnv):
    """
    ...
    cfg: AvoidCollisionUAVSwarmEnvCfg

    def __init__(self, cfg: AvoidCollisionUAVSwarmEnvCfg, render_mode: str | None = None, **kwargs):
